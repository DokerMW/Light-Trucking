...
// @prepros-append inputmask.min.js
...
document.addEventListener('DOMContentLoaded', function () {
	...
	let successPopup = document.querySelector('.popup-sending');
	async function formSend(e) {
		...
		if (error === 0) {
			...
			let response = await fetch('readytoroll.php', {
				method: 'POST',
				body: formData
			});
			if (response.ok) {
...
document.addEventListener('DOMContentLoaded', function () {
	...
	async function formSend2(e) {
		...
		if (error === 0) {
			...
			let response = await fetch('driverswanted.php', {
				method: 'POST',
				body: formData2
			});
			if (response.ok) {
...
document.addEventListener('DOMContentLoaded', function () {
	...
	async function formSend3(e) {
		...
		if (error === 0) {
			...
			let response = await fetch('contactus.php', {
				method: 'POST',
				body: formData3
			});
			if (response.ok) {
	...
	function formValidate(form3) {
		let error = 0;
		let formReq3 = document.querySelectorAll('._req3');
...
document.addEventListener('DOMContentLoaded', function () {
	...
	async function formSend4(e) {
		...
		if (error === 0) {
			...
			let response = await fetch('truckdrivers.php', {
				method: 'POST',
				body: formData4
			});
			if (response.ok) {
	...
	function formValidate(form4) {
		let error = 0;
		let formReq4 = document.querySelectorAll('._req4');
...
document.addEventListener('DOMContentLoaded', function () {
	...
	async function formSend5(e) {
		...
		let error = formValidate(form5);

		let formData5 = new FormData(form5);

		if (error === 0) {
			form5.classList.add('_sending');
			let response = await fetch('owneroperator.php', {
				method: 'POST',
				body: formData5
			});
			if (response.ok) {
	...
	function formValidate(form5) {
		let error = 0;
		let formReq5 = document.querySelectorAll('._req5');

		for (let index = 0; index < formReq5.length; index++) {
			const input = formReq5[index];
			formRemoveError(input);
...
//===== form6 ==============================================================================//
document.addEventListener('DOMContentLoaded', function () {
	const form6 = document.getElementById('form_6');
	form6.addEventListener('submit', formSend6);

	async function formSend6(e) {
		e.preventDefault();

		let error = formValidate(form6);

		let formData6 = new FormData(form6);

		if (error === 0) {
			form6.classList.add('_sending');
			let response = await fetch('dispatchers.php', {
				method: 'POST',
				body: formData6
			});
			if (response.ok) {
	...
	function formValidate(form6) {
		let error = 0;
		let formReq6 = document.querySelectorAll('._req6');

		for (let index = 0; index < formReq6.length; index++) {
			const input = formReq6[index];
			formRemoveError(input);
...
//===== form7 ==============================================================================//
document.addEventListener('DOMContentLoaded', function () {
	const form7 = document.getElementById('form_7');
	form7.addEventListener('submit', formSend7);

	async function formSend7(e) {
		e.preventDefault();

		let error = formValidate(form7);

		let formData7 = new FormData(form7);

		if (error === 0) {
			form7.classList.add('_sending');
			let response = await fetch('recruiters.php', {
				method: 'POST',
				body: formData7
			});
			if (response.ok) {
				...
				//alert(result.message);
				form7.reset();
				form7.classList.remove('_sending');
				successPopup.classList.add('_active');
			} else {
				alert('Ошибка');
				form7.classList.remove('_sending');
	...
	function formValidate(form7) {
		let error = 0;
		let formReq7 = document.querySelectorAll('._req7');

		for (let index = 0; index < formReq7.length; index++) {
			const input = formReq7[index];
			formRemoveError(input);
...
//===== form8 ==============================================================================//
document.addEventListener('DOMContentLoaded', function () {
	const form8 = document.getElementById('form_8');
	form8.addEventListener('submit', formSend8);

	async function formSend8(e) {
		e.preventDefault();

		let error = formValidate(form8);

		let formData8 = new FormData(form8);

		if (error === 0) {
			form8.classList.add('_sending');
			let response = await fetch('department.php', {
				method: 'POST',
				body: formData8
			});
			if (response.ok) {
				...
				//alert(result.message);
				form8.reset();
				form8.classList.remove('_sending');
				successPopup.classList.add('_active');
			} else {
				alert('Ошибка');
				form8.classList.remove('_sending');
	...
	function formValidate(form8) {
		let error = 0;
		let formReq8 = document.querySelectorAll('._req8');

		for (let index = 0; index < formReq8.length; index++) {
			const input = formReq8[index];
			formRemoveError(input);
...
let menuBody = document.querySelector('.menu__body'); //получаем еще один класс в константу
...
var swiperVert = new Swiper('.slider-partners_vertical', {
	// Скролл:
...
var sliderReview = new Swiper('.image-slider', {
	// стрелки
	navigation: {
	...
	keyboard: {
		...
		onlyInViewport: true,
		// вкл/выкл управление клавишами PageUp и PageDown
		pageUpDown: true,
	},
